        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style=" background-color:#2E2E2F;"> 
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers.php" style="color:white;font-weight:1em;">
...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:#fc6e09;font-family: 'poppins';font-size:2.2em;padding:3%;">Transfer Record</h3>
    <table id="myTable">
          <tr>
            <th>Transfer ID</th>
            <th>Sender</th>
